class EmployeeDto {
  ...
  factory EmployeeDto.fromJson(Map<String, dynamic> json) {
    return EmployeeDto(
      account:
          json['account'] != null ? AccountDto.fromJson(json['account']) : null,
  ...
  factory AccountDto.fromJson(Map<String, dynamic> json) {
    return AccountDto(
      ...
      roles: json['roles'] != null
          ? List<RoleDto>.from(
              (json['roles'] as List).map((x) => RoleDto.fromJson(x)))
          : null,
      accesses: json['accesses'] != null
          ? List<AccessDto>.from(
              (json['accesses'] as List).map((x) => AccessDto.fromJson(x)))
          : null,
  ...
  factory OrganizationDto.fromJson(Map<String, dynamic> json) {
    return OrganizationDto(
      ...
      location: json['location'] != null
          ...
          : null,
      organizationConfig: json['organizationConfig'] != null
          ? OrganizationConfigDto.fromJson(json['organizationConfig'])
          : null,
    );
  }
}
  ...
  factory LocationDto.fromJson(Map<String, dynamic> json) {
    return LocationDto(
      ...
      workingSchedule: json['workingSchedule'] != null
          ? WorkingScheduleDto.fromJson(json['workingSchedule'])
          : null,
      locationDetail: json['locationDetail'] != null
          ? LocationDetailDto.fromJson(json['locationDetail'])
          : null,
    );
  }
}
...
class JobDto {
  ...
  factory JobDto.fromJson(Map<String, dynamic> json) {
    return JobDto(
      ...
      jobGroup:
          json['jobGroup'] != null ? JobGroupDto.fromJson(json['jobGroup']) : null,
    );
  }
}
